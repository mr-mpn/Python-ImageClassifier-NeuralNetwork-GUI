...
1- Taipy is used as as the graphical user interface for our application.
...
2- Neural Network Machine Learning approach is used in order to make a prediction on image provided by the user.
...
By Normaliztion the values go in the range of zero and organizes
...
one hot encode behaves as the following :
